-- ============================================================================
-- Colorscheme Configuration - DOOM Themed Collection
-- ============================================================================

return {
  -- Tokyo Night colorscheme (current default)
  {
  ...
  -- Doom One - Classic DOOM colors
  {
    "NTBBloodbath/doom-one.nvim",
    lazy = true,
    config = function()
      -- Set doom-one configuration variables
